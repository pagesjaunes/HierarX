...
#ifndef HIERARX_RANDOM_H
#define HIERARX_RANDOM_H
...
public:
    static int NaturalInteger(int);
    static double Double(double);
    static double Double(double, double);
    static std::vector<double> DoubleVector(double, double, int);

};


#endif //HIERARX_RANDOM_H
